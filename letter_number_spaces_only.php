...
// Plugin
class plgCCK_Field_ValidationLetter_Number_Spaces_Only extends JCckPluginValidation
{
	protected static $type	=	'letter_number_spaces_only';
	protected static $regex	=	'/^[a-zA-Z0-9\s]+$/';
